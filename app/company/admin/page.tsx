        ...
        <div className="fixed inset-0 flex items-center justify-center modal-backdrop z-50">
          <div className="bg-white rounded-lg shadow-xl w-full max-w-5xl relative">
            ...
            <div className="px-8 pt-6 pb-3 border-b border-gray-200">
              <h2 className="text-lg font-bold" style={{ color: "var(--color-black)" }}>Edit Company</h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 divide-y md:divide-y-0 md:divide-x divide-gray-200">
              ...
              <div className="p-8 space-y-5">
                <div>
                  <label className="block text-sm mb-1 font-semibold" style={{ color: "var(--color-black)" }}>Company Name</label>
                ...
                <div>
                  <label className="block text-sm mb-1 font-semibold" style={{ color: "var(--color-black)" }}>Company Logo</label>

                  <div className="upload-box border-2 border-dashed border-gray-300 rounded-lg h-40 flex flex-col items-center justify-center text-gray-500 cursor-pointer">
                    {logoFile ? (
                      ...
                      <>
                        ...
                        <label className="text-[var(--color-primary)] cursor-pointer text-sm font-semibold">
                          Browse
                          <input
                            type="file"
                            accept="image/*"
              ...
              <div className="p-8 space-y-5">
                <div>
                  <label className="block text-sm mb-1 font-semibold" style={{ color: "var(--color-black)" }}>Location</label>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="block text-sm mb-1 font-semibold" style={{ color: "var(--color-black)" }}>Latitude</label>
                    <div className="flex items-center gap-2">
                      <input
                        type="text"
                        value={latitude}
                  ...
                  <div>
                    <label className="block text-sm mb-1 font-semibold" style={{ color: "var(--color-black)" }}>Longitude</label>
                    <div className="flex items-center gap-2">
                      <input
                        type="text"
                        value={longitude}
            ...
            <div className="flex justify-end gap-3 border-t border-gray-200 px-8 py-4">
              <button
                ...
                className="px-5 py-2 border border-blue-950 rounded-md font-bold hover:bg-gray-100" style={{ color: "var(--color-primary)" }}
              >
                Cancel
              </button>

              <button onClick={handleSave} className="btn-primary w-auto px-6">
                Save
              </button>
            </div>
